...
insert into ORDERS values(10001, 'Travessa Tiradentes 1', sysdate()-1, 'Concluded')
...
insert into payment values(10003, '400.1232.1232', sysdate() - 15, 'Open', 10001)
insert into payment values(10004, '400.1232.1232', sysdate() - 20, 'Waiting', 10001)
insert into payment values(10007, '400.1232.1232', sysdate() - 10, 'Concluded', 10001)
